  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        description:
          "We create innovative IT solutions that drive your business forward",
        cta: "Get Started",
        contact: "Contact Us",
      },
      services: {
  ...
  uz: {
    translation: {
      ...
      hero: {
        ...
        description:
          "Biz biznesingizni oldinga siljitadigan innovatsion IT yechimlarini yaratamiz",
        cta: "Boshlash",
        contact: "Aloqa",
      },
      services: {
  ...
  ru: {
    translation: {
      ...
      hero: {
        ...
        description:
          "Мы создаём инновационные IT решения, которые продвигают ваш бизнес вперёд",
        cta: "Начать",
        contact: "Связаться",
      },
      services: {
